...
./helper/ft_stoip.c ./helper/ft_sorter_utils.c
...
./helper/ft_sorter.c ./helper/ft_below_50.c ./sorter/ft_bubble_sort.c ./helper/ft_small_sort.c ./helper/ft_small_sorter_helper.c
